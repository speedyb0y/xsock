...
#define XCONF_XSOCK_CLT_PATH_0_PKTS (10*1000*1000)
#define XCONF_XSOCK_CLT_PATH_1_PKTS ( 2*1000*1000)
#define XCONF_XSOCK_CLT_PATH_2_PKTS (20*1000*1000)

#define XCONF_XSOCK_SRV_PATH_0_PKTS (40*1000*1000)
#define XCONF_XSOCK_SRV_PATH_1_PKTS ( 7*1000*1000)
#define XCONF_XSOCK_SRV_PATH_2_PKTS (50*1000*1000)
