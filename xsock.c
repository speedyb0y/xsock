/*
    ...
    TODO: SE FOR USAR MODO ROUTER COM OUTROS HOSTS, ENTÃO VAI TER QUE AUMENTAR O HEAD SPACE DAS INTERFACES CONECTADAS A ELES
...
#define XSOCK_CLIENT_ID   XCONF_XSOCK_CLIENT_ID
...
static void xsock_setup (net_device_s* const dev) {
    ...
    dev->addr_len        = 0;
    dev->hard_header_len = ETH_HLEN + sizeof(xsock_wire_hash_t);
    dev->min_header_len  = ETH_HLEN + sizeof(xsock_wire_hash_t);
    //dev->needed_headroom = ;
    //dev->needed_tailroom = ;
