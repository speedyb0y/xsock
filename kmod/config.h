...
#define XCONF_XSOCK_SRV_PATH_0_PKTS (12*1000*1000)/1500
#define XCONF_XSOCK_SRV_PATH_1_PKTS ( 5*1000*1000)/1500
#define XCONF_XSOCK_SRV_PATH_2_PKTS (14*1000*1000)/1500
