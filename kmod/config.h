...
#define XCONF_XSOCK_SRV_PATH_0_PKTS (20*1000*1000)/1500
#define XCONF_XSOCK_SRV_PATH_1_PKTS ( 8*1000*1000)/1500
#define XCONF_XSOCK_SRV_PATH_2_PKTS (22*1000*1000)/1500
